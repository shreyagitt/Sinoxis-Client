...
exports.userController = {
    ...
    list: (0, errorHandler_1.asyncHandler)(async (_req, res) => {
        const users = await User_1.User.find({ role: "client" })
            .select("-password")
            .sort({ createdAt: -1 });
        res.json({
            success: true,
    ...
    update: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        ...
        if (normalizedEmail && normalizedEmail !== user.email) {
            const emailExists = await User_1.User.findOne({ email: normalizedEmail });
            if (emailExists) {
                return res.status(409).json({
                    success: false,
    ...
    /* ============================================================
       ...
       ============================================================ */
    updatePermissions: (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    /* ============================================================
       ...
       ============================================================ */
    block: (0, errorHandler_1.asyncHandler)(async (req, res) => {
