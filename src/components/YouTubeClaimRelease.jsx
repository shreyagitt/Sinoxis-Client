...
const ClaimSchema = Yup.object({
  ...
  youtubeLink: Yup.string().url("Enter a valid YouTube link").required("YouTube link is required"),
            ...
            {({ setFieldValue }) => (
              <Form className="space-y-6">
                ...
                <FieldGroup
                  ...
                  helper="Paste the full YouTube URL of the video with the claim"
                />
                ...
                <div>
                  ...
                  <ErrorMessage name="claimType" component="p" className="text-red-600 text-xs mt-1" />
                </div>
                ...
                <TextAreaGroup
                  label="Claim Details"
                  name="claimDetails"
                  placeholder="Provide details including timestamps if applicable"
                />
...
<div>
  ...
  <p className="text-xs text-gray-500 mt-1">
    Upload a screenshot showing the claim details (optional but recommended)
  </p>
</div>
                ...
                <TextAreaGroup
                  ...
                  name="additionalInfo"
                  rows={3}
                  placeholder="Any extra information to help process your request"
                />
                ...
                <div className="flex justify-end gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="bg-red-600 hover:bg-red-700 text-white px-5 py-2 text-sm rounded-md font-medium"
                  >
                    Submit Claim
                  </button>
                </div>
